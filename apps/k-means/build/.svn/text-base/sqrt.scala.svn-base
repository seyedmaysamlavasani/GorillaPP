...
class sqrt (extCompName:String) extends gComponentLeaf  (() => new FU_in_t)(() => new FU_out_t) (ArrayBuffer())  (extCompName = extCompName + "__type__engine__MT__1__") with include {
  val numOfThreads = 1 
