...
class Top extends Component with GorillaUtil {
  ...
  val incThroughOffload_MD = new gComponentMD(() => new testStruct_t, () => new testStruct_t, ArrayBuffer(("incrementFactor", () => UFix(width = 32) , () => UFix(width = 32))))
  val  main =  (incThroughOffload_MD , () => new incThroughOffload (extCompName="main")).asInstanceOf[(gComponentMD[Chisel.Data,Chisel.Data], () => gComponent[Chisel.Data,Chisel.Data])]
  val sendConst_MD = new gComponentMD(() => UFix(width = 32), () => UFix(width = 32), ArrayBuffer())
  val  incFactor =  (sendConst_MD , () => new sendConst (extCompName="incFactor") ).asInstanceOf[(gComponentMD[Chisel.Data,Chisel.Data], () => gComponent[Chisel.Data,Chisel.Data])]
  val  result = Offload (main, incFactor, "incrementFactor", extCompName="result")
  val generatedTop = result._2()
  generatedTop.io <> io
}
