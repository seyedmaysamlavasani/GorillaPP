...
class multiplier (extCompName:String) extends gComponentLeaf  (() => new FU_in_t)(() => new FU_out_t) (ArrayBuffer())  (extCompName =  extCompName + "__type_engine__pipelined__") with include {
  val tagWidth = 5*2
  val numOfThreads = 4 
