...
//class SendConstantgComonent extends gComponentLeaf (() => UFix(width = 32)) (() => UFix(width = 32)) (ArrayBuffer(("test", () => UFix(width = 32), ()=> UFix(width = 32)))) {
class SendConstantgComonent extends gComponentLeaf (() => UFix(width = 32)) (() => UFix(width = 32)) (ArrayBuffer()) {
...
class Offloaded extends Component with GorillaUtil {
 ...
 val d = (b, () => new SendConstantgComonent)
