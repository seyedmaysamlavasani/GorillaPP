...
class IncgComponent extends gComponentLeaf (() => UFix(width = 32)) (() => UFix(width = 32)) (ArrayBuffer(("testOff", () => UFix(width = 32)))) {
...
class Chained extends Component with GorillaUtil {
 ...
 val a = new gComponentMD (() => UFix(width = 32), () => UFix(width = 32), ArrayBuffer(("testOff1", () => UFix(width = 32))))
 val b = new gComponentMD (() => UFix(width = 32), () => UFix(width = 32), ArrayBuffer(("testOff2", () => UFix(width = 32))))
