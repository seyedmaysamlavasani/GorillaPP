...
//  val incThroughOffload_MD =new gComponentMD(() => UFix(width = 32), () => UFix(width = 32), ArrayBuffer(("constOff", () => UFix(width = 32) , () => UFix(width = 32))))
//  //val main =  (incThroughOffload_MD , () => new incThroughOffload)
//  val main =  (incThroughOffload_MD , () => new IncThroughOffloadgComponent )
...
//  val result =  Offload(Replicate(main, 2), incFactor, "constOff")
//  val generatedTop = result._2()
//  generatedTop.io <> io
//}

class Toptop extends Component with GorillaUtil {
...
class TopTests(o: Toptop) extends Tester(o, Array(o.io)) {
  defTests {
